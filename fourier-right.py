...
def fourier_demo():
    ...
    #1、灰度化读取文件，
    img = cv2.imread('C:/Users/LaOzhOy1/Pictures/Camera Roll/test.bmp',0)
    cv2.resizeWindow("origin picture", 640, 480);
    cv2.namedWindow('origin picture', 0)
    ...
    cv2.resizeWindow("rotated", 640, 480);
