...
def compare_idDiff(orgin,test):
    ...
    return True
def isBad(test_dir):
    origin_dir = 'C:/Users/LaOzhOy1/Pictures/Camera Roll/origin.bmp'
    # test_dir = 'C:/Users/LaOzhOy1/Pictures/Camera Roll/test.bmp'
    test_img = Select_Main(test_dir)
    origin_img = Select_Main(origin_dir)
    compare_idDiff(origin_img,test_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    # test_img = test_img.reshape([1021,2752,3])
    # origin_img = origin_img.reshape([1021,2752,3])
    # print(type(origin_img))
    # print(type(test_img))
    # print(origin_img.shape)
    # print(test_img.shape)
    # dist = cv2.Canny(origin_img,200,300)
    # dist2 = cv2.Canny(test_img,200,300)
    # cv2.imshow( '',dist2-dist)
    # cv2.imwrite("origin_produce.jpg", origin_img)
    # cv2.imwrite("test_produce.jpg", test_img)
